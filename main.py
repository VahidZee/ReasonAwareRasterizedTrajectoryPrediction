...
if __name__ == '__main__':
    ...
    training_procedure = LyftTrainerModule(
        model=args.model, config=config, optimizer=args.optimizer, optimizer_dict=args.optimizer_dict, modes=args.modes,
        lr=args.lr, scheduler=args.scheduler, scheduler_dict=args.scheduler_dict,
        saliency_factor=args.saliency_factor, saliency_intrest=args.saliency_intrest,
        saliency_dict=args.saliency_dict, pgd_iters=args.pgd_iters, pgd_alpha=args.pgd_alpha,
        pgd_random_start=args.pgd_random_start, pgd_eps_vehicles=args.pgd_eps_vehicles,
        pgd_eps_semantics=args.pgd_eps_semantics, track_grad=args.track_grad, **args.kwargs)
